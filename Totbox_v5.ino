...
const int buttonPin2 = 7;       // assigns buttonPin to pin 7 on Arduino
const int noisePin = 16;        // assigns noisePin to pin 16 (A2) on Arduino
...
void loop() {
  ...
  if(  millis() >= fade_goTime) fade();       // my LED fading function. Need to grok this
